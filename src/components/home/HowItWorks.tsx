...
const steps = [
  {
    ...
    description: "Sign up in under 2 minutes with just your email. No hidden fees, no credit card required.",
    color: "primary",
  },
  {
    icon: CreditCard,
    title: "Select Your Gift Card",
    description: "Choose from 100+ major brands — Amazon, Apple, Steam, Netflix, and more. Buy or sell instantly.",
    color: "secondary",
  },
  {
    icon: DollarSign,
    title: "Enter Amount & Details",
    description: "Set your card value and see instant payout calculations. Country-specific rates for the best deal.",
    color: "primary",
  },
  {
    icon: CheckCircle,
    title: "Get Paid in Under 1 Hour",
    description: "Receive instant payout via PayPal or Binance Pay. Buying? Get your gift card code delivered to your dashboard.",
    color: "secondary",
  },
];
      ...
      <div className="container mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-4">
            How to Buy & Sell Gift Cards Online
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Whether you're selling gift cards for instant cash or buying discounted gift cards, 
            our 4-step process makes gift card trading quick, secure, and hassle-free.
          </p>
        </div>

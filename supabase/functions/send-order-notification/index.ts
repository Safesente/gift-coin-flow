...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    console.log("Sending order notification to:", email, "for", orderType, "order, status:", status);
            ...
            <div style="padding: 40px 30px;">
              ...
              <div style="background: #f8fafc; border-radius: 12px; padding: 24px; margin: 24px 0;">
                <div style="display: flex; justify-content: space-between; margin-bottom: 12px;">
                  <span style="color: #64748b;">Gift Card:</span>
                  <span style="color: #334155; font-weight: 600;">${cardName}</span>
                </div>
                <div style="display: flex; justify-content: space-between; margin-bottom: 12px;">
                  <span style="color: #64748b;">Amount:</span>
                  <span style="color: #334155; font-weight: 600;">$${amount} x ${quantity}</span>
                </div>
